...
public class CreateFolderActivity extends AsyncTask<String, String, String>{
    ...
    public CreateFolderActivity(Context context, FilesFragment filesFragment) {
    ...
    protected String doInBackground(String... arg0) {
        try{
            ...
            String link="http://"+serverip+"/mobile_methods/file_create_dir.php";
